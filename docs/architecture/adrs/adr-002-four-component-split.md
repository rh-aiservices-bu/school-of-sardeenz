...
| **Engine Plugins**  | Abstraction layer that encapsulates engine-specific behavior (health checks, memory reporting, lifecycle signals, sleep/wake support) behind a common contract. Each supported engine (vLLM, Triton, diffusion pipelines, etc.) implements this contract.                                                                                                                                               |
