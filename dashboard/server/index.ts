  ...
  app.log.info(
    {
      ...
      prometheusAuth: Boolean(config.prometheusBearerTokenPath),
      prometheusTls: Boolean(config.prometheusCaPath),
      prometheusTenantNamespace: config.prometheusTenantNamespace || undefined,
