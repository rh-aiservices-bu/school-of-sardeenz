...
Gates 0–6 are the **CPU gates** — they run on any 4.15+ worker Pod. Gates 7–9 and the Gate 10
...
(`/weights`), `VLLM_SIF` (`/modules/vllm-0.21.sif`), `AGENT_URL` (`http://127.0.0.1:9100`).
...
comparison against the spike's EFS floor.
